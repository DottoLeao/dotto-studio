...
export function Hero() {
  ...
  return (
    ...
    >
      {/* `data-enter` é a abertura da página: escada única, disparada na
          montagem do runtime. A ordem no DOM é a ordem da escada. */}
      <div
        data-enter
        className="mx-auto flex w-full max-w-[1280px] items-start justify-between gap-6"
      >
        <BrandMark />
      ...
      <div data-hero-inner className="mx-auto w-full max-w-[1280px] py-16">
        <p data-enter className="eyebrow text-signal">
          {t("eyebrow")}
        </p>

        <h1
          data-enter
          className="display-tight mt-7 max-w-[19ch] text-h1 text-balance"
        >
          {t("headline")}
        </h1>
        ...
        <p
          data-enter
          className="mt-8 max-w-[54ch] text-lead leading-[1.28] text-bone/72"
        >
          {t("lead")}
        </p>

        <div data-enter className="mt-11 flex flex-wrap gap-3">
      ...
      <div
        data-enter
        className="mx-auto flex w-full max-w-[1280px] flex-wrap items-end justify-between gap-4"
      >
